...
### Logistic Regression
```{r logistic_regression, echo=FALSE, out.width='500px', out.height='500px', fig.align= 'center'}
...
```{r pca, echo=FALSE, out.width='1100px', out.height='500px', fig.pos = 'left'}
knitr::include_graphics("/cloud/project/results/PCA_rotation_matrix.png")
```
