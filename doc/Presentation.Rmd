...
<div style="float: left; width: 50%;">
```{r recreation_percent_histologi, echo=FALSE, out.width='280px', out.height='280px', fig.align= 'center'}
...
```{r original_age_cancer_type, echo=FALSE, out.width='400px', out.height='200px', fig.align= 'center'}
