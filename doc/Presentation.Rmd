...
<div style="float: left; width: 50%;">
```{r percent_histologi, echo=FALSE, out.width='300px', out.height='230px', fig.align= 'center'}
...
```{r age_cancer_type, echo=FALSE, out.width='450px', out.height='300px', fig.align= 'center'}
...
<div style="float: left; width: 50%;">
```{r datavis1, echo=FALSE, out.width='280px', out.height='280px', fig.align= 'center'}
