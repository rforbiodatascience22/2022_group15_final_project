...
```{r percent_histologi, echo=FALSE, out.width='290px', out.height='270px', fig.align= 'center'}
knitr::include_graphics(c("/cloud/project/doc/original_percent_histologi.png","/cloud/project/results/recreation_percent_histology.png"))
```
</div>
...
knitr::include_graphics(c("/cloud/project/results/death_month_distribution.png","/cloud/project/results/distribution_of_tumour_stage_and_patient_status.png"))
```
</div>

<div style="float: left; width: 50%;">
```{r datavisualization2, echo=FALSE, out.width='370px', out.height='270px', fig.align= 'center'}
knitr::include_graphics(c("/cloud/project/results/histology_density_by_protein.png","/cloud/project/results/age_boxplot.png"))
```
</div>
